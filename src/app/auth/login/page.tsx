...
import { Mail, Lock, Loader2, Eye, EyeOff, Database } from "lucide-react";
        ...
        <AuthLayout>
            <div className="space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center gap-2.5">
                        <input
                            ...
                            className="h-4 w-4 rounded-md border-zinc-300 dark:border-zinc-600 text-indigo-500 focus:ring-indigo-500/20"
                        />
                ...
                <p className="text-center text-sm text-muted-foreground">
                    ...
                    <Link href="/auth/register" className="text-indigo-500 dark:text-indigo-400 font-medium hover:underline">
                        Créer un compte
                    </Link>
                </p>
            </div>
